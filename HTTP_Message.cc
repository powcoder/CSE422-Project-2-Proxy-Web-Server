...
HTTP_Message::HTTP_Message() { /*Nothing to do...*/ }
...
/**
 * Parse the received data to construct the object
 *
...
/**
 * Construct a string that represents this message, for sending or
 * other purposes.
 *
 * @param[out] output_string The string to hold the message.
 */
 ...
 * other purposes
 *
 * @param[out] output_buffer The char array to hold the message.
...
/**
 * Copy the data_string into the buffer, if the buffer stil has room
 * for this data_string, otherwise copy as much as there is room.
 *
 * @param[out] output_buffer The char array to store data_string
 * @param[in] data_string The string to be copied
 * @param[in] remaining_length The remaining room of the buffer
 */
void HTTP_Message::copy_if_room(char*& output_buffer,
        const char* data_string, unsigned& remaining_length) const {
...
/**
 * Scan the data char-by-char until a newline char is found.
 *
 * @param data The char array to be scaned
 * @param length The length of the data
 * @return Pointer to the beginning of next line.
 */
...
bool HTTP_Message::get_header_value(const string& name, string& out_value) const {
...
void HTTP_Message::remove_header_field(const string& name) {
    headers.erase(name);
}
